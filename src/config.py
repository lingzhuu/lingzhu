...
def add_find_latent_representations_args(parser):
    ...
    parser.add_argument(
        "--input_format", type=str, choices=["visium"],
        help="Specify 'visium' to load 10X Visium data. If not provided, will load an HDF5 file."
    )
    parser.add_argument(
        "--input_path", required=True, type=str, help="Full path to the input file. For h5ad format, provide the HDF5 file path. For Visium, provide the directory containing Visium data files."
    )
    parser.add_argument(
        "--data_layer",
        type=str,
